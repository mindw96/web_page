...
class ChatScreenState extends State<SOLARScreen> {
  ...
  Future<void> _initializeFirebase() async {
    ...
    if (uid != null) {
      ...
      ).ref('users').child(uid!).child('solar-mini');
  ...
  void _sendMessage(SOLARMessageService messageService, String userMessage) {
